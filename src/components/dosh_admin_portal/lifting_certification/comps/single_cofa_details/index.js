...
const SingleCofaComp = (props) => {
  ...
  try {
    const res = await axios.post(
      `${main_url}/lifting/dosh/approve/${router.query.single_id}`,
     {},
      {
        headers: {
          "Content-Type": "application/json",
    ...
    display: "grid",
     ...
     <div>
                  ...
                  <div>
                    ...
                    >
                      {single_cofa?.data?.certification?.company_name}
                    </div>
                  </div>
                   <div>
                    <div
                    ...
                    >
                      {single_cofa?.data?.certification?.location}
                    </div>
                  </div>
                    <div>
                    <div
                   ...
                   Entitled as
                    ...
                    >
                      {single_cofa?.data?.certification?.entitled_as}
                    </div>
                  </div>
                    <div>
                    <div
                  ...
                  Area of specialisation
                    ...
                    >
                      {single_cofa?.data?.certification?.area_of_specialisation}
                    </div>
                  </div>
                  <div>
                    <div
                 ...
                 Period of validity of Authorisation
                    ...
                    >
                      {moment(single_cofa?.data?.certification?.period_of_validity_of_authorisation?.start_date).format("YYYY-MM-DD")} - {moment(single_cofa?.data?.certification?.period_of_validity_of_authorisation?.end_date).format("YYYY-MM-DD")}
                    </div>
                  </div>
                   <div>
                    <div
