...
import DeclarationPopup from "@/src/components/dosh_admin_portal/factory_component/tabs/comps/declaration_popup";import toast, { Toaster } from "react-hot-toast";
...
const uploadFiles = async (url, files) => {
  ...
  const {
   ...
   const add_comments = () => {
    ...
    axios
      .post(
        `${main_url}/lifting/equipment/dosh/comment`,
        {
